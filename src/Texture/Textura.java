...
public class Textura {
    ...
    public Textura(final InputStream is , int rows , float transparency) {
        this.rows = rows;
    ...
    public final void glInit() {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, this.image.getWidth(), this.image.getHeight(), 0, GL_BGRA, GL_UNSIGNED_BYTE, this.buffer);
