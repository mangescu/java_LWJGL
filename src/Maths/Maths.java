...
public class Maths {
    ...
    ShaderProgram shaderProgram;
        ...
        float deltaAB , deltaBC , deltaCA;
        Vector3f P  = new  Vector3f();

    Line2D v_1 = new Line2D.Float();
    Line2D v_2 = new Line2D.Float();
                 
    public Maths(ArrayList<Player>    playerList){
	...
	public  Matrix4f createViewMatrix(Camera camera){
                ...
                viewMatrix.rotateX((float) Math.toRadians(camera.getPitch()),viewMatrix)
                          .rotateY((float) Math.toRadians(camera.getPitch()),viewMatrix)
...
//    public boolean checkPlayerSegmentIntersection(Vector3f A , Vector3f B , Player player){
//        boolean ok = false;
...
//            {
//                for (int i = 0; i < play.borderPVector_temp.size(); i++)
//                {
//                    if(i == play.borderPVector_temp.size() - 1)
//                    {
//                        if (checkSegmentColision(A, B, play.borderPVector_temp.get(i).borderPVector, play.borderPVector_temp.get(0).borderPVector))
//                        {
//                            ok = true;
//                        }
//
//                    } else {
//                              if (checkSegmentColision(A, B, play.borderPVector_temp.get(i).borderPVector, play.borderPVector_temp.get(i + 1).borderPVector))
//                              {
//                                ok = true;
//                              }
//                          }
