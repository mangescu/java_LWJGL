...
public class Quad {
    ...
    public boolean shipTargerLockStatus = false;
...
public Vector3f canon_1;
public Vector3f canon_2; 
public Vector3f canon_3;
...
public boolean  isSelectebel = true;
 ...
 public Vector3f  border_vec_2;
    ...
    public void printXY(){
        System.out.println("X = "+curentPosition.x+"   Y = "+curentPosition.y);
    }
