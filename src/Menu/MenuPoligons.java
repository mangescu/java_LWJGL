...
public class MenuPoligons {
    ...
    public  void createPoligon(Textura poliTex , Camera cam, float x , float y   , float width , float height , int index, float  rotate)
    {
        poligon = new Quad();
        ...
        model = new Model(ibo, poliTex, 0, poligon.curentPosition, new Vector3f(0,0,rotate) , poligon.scale);
        model.INDEX_T  = index;
